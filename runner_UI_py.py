...
def main(report):
    ...
    os.system(f'pytest {BASE_DIR}/TestCases/Login/test_login.py -v --html={BASE_DIR}/Report/{report_dir_format}/{report_dir_format}_report_{num}_.html --self-contained-html')
